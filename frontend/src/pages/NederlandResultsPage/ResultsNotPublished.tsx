...
export default function ResultsNotPublished() {

    return (
        <Layout
            title={`Nederland - resultaten nog niet gepubliceerd`}
            description={`Nederland - resultaten nog niet gepubliceerd`}
        >
            <PageTop
                title={`Tweede kamer verkiezing 2025`}
            ...
            <div className={'page-main page-main-w-half'}>
                ...
                <h2 className="result-unpublished">
                    De telresultaten van Nederland zijn nog niet gepubliceerd
                </h2>

                {/* Info box */}
                <InfoBox>
                    <span>
                        De telresultaten en processen-verbaal van de gemeente Lisserdam zijn hier in te zien zodra de gemeente ze publiceert. 
                    </span>
                </InfoBox>
